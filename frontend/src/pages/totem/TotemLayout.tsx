...
import { Command, Home, Maximize, Minimize } from 'lucide-react';
    ...
    >
      ...
      <header className="bg-white border-b px-8 py-6 flex items-center justify-between shadow-sm z-10">
        <div className="flex items-center gap-4">
          <div
            className="flex aspect-square size-8 items-center justify-center rounded-lg bg-primary text-primary-foreground cursor-pointer"
